...
#include "Ieee80211NewMacWithRA.h"
...
Define_Module(Ieee80211NewMacWithRA);

// don't forget to keep synchronized the C++ enum and the runtime enum definition
Register_Enum(Ieee80211NewMacWithRA,
              (Ieee80211NewMacWithRA::IDLE,
               Ieee80211NewMacWithRA::DEFER,
               Ieee80211NewMacWithRA::WAITAIFS,
               Ieee80211NewMacWithRA::BACKOFF,
               Ieee80211NewMacWithRA::WAITACK,
               Ieee80211NewMacWithRA::WAITBROADCAST,
               Ieee80211NewMacWithRA::WAITCTS,
               Ieee80211NewMacWithRA::WAITSIFS,
               Ieee80211NewMacWithRA::RECEIVE));
...
Ieee80211NewMacWithRA::Ieee80211NewMacWithRA()
{
    endSIFS = NULL;
    endDIFS = NULL;
    endTimeout = NULL;
 ...
 */
void Ieee80211NewMacWithRA::initialize(int stage)
{
...
//end auto rate code
        ...
        // state variables
        fsm.setName("Ieee80211NewMacWithRA State Machine");
        mode = DCF;
        sequenceNumber = 0;
        ...
        stateVector.setEnum("Ieee80211NewMacWithRA");
...
void Ieee80211NewMacWithRA::initWatches()
{
// initialize watches
     WATCH(fsm);
     WATCH(radioState);
...
void Ieee80211NewMacWithRA::finish()
{
...
void Ieee80211NewMacWithRA::registerInterface()
{
...
void Ieee80211NewMacWithRA::initializeQueueModule()
{
 ...
 */
void Ieee80211NewMacWithRA::handleSelfMsg(cMessage *msg)
{
...
void Ieee80211NewMacWithRA::handleUpperMsg(cPacket *msg)
{
...
int Ieee80211NewMacWithRA::MappingAccessCategory(Ieee80211DataOrMgmtFrame *frame)
{
...
void Ieee80211NewMacWithRA::handleCommand(cMessage *msg)
{
...
void Ieee80211NewMacWithRA::handleLowerMsg(cPacket *msg)
{
...
void Ieee80211NewMacWithRA::receiveChangeNotification(int category, const cPolymorphic *details)
{
    Enter_Method_Silent();
...
void Ieee80211NewMacWithRA::finishReception()
{
    if (getCurrentTransmission())
    {
        backoff() = true;
 ...
 * Timing functions.
 */
simtime_t Ieee80211NewMacWithRA::getSIFS()
{
...
simtime_t Ieee80211NewMacWithRA::getSlotTime()
{
...
simtime_t Ieee80211NewMacWithRA::getPIFS()
{
    return getSIFS() + getSlotTime();
}

simtime_t Ieee80211NewMacWithRA::getDIFS(int category)
{
...
simtime_t Ieee80211NewMacWithRA::getHeaderTime(double bitrate)
{
    ModulationType modType;
    if ((opMode=='b') || (opMode=='g'))
        modType = WifyModulationType::getMode80211g(bitrate);
...
simtime_t Ieee80211NewMacWithRA::getAIFS(int AccessCategory)
{
    return AIFSN(AccessCategory) * getSlotTime() + getSIFS();
}

simtime_t Ieee80211NewMacWithRA::getEIFS()
{
...
simtime_t Ieee80211NewMacWithRA::computeBackoffPeriod(Ieee80211Frame *msg, int r)
{
    int cw;
 ...
 * Timer functions.
 */
void Ieee80211NewMacWithRA::scheduleSIFSPeriod(Ieee80211Frame *frame)
{
...
void Ieee80211NewMacWithRA::scheduleDIFSPeriod()
{
...
void Ieee80211NewMacWithRA::cancelDIFSPeriod()
{
    EV << "cancelling DIFS period\n";
    cancelEvent(endDIFS);
}

void Ieee80211NewMacWithRA::scheduleAIFSPeriod()
{
    bool schedule=false;
    for (int i =0; i<numCategories(); i++)
    {
...
void Ieee80211NewMacWithRA::rescheduleAIFSPeriod(int AccessCategory)
{
    ASSERT(1);
...
void Ieee80211NewMacWithRA::cancelAIFSPeriod()
{
...
//XXXvoid Ieee80211NewMacWithRA::checkInternalColision()
//{
//  EV << "We obtain endAIFS, so we have to check if there
//}


void Ieee80211NewMacWithRA::scheduleDataTimeoutPeriod(Ieee80211DataOrMgmtFrame *frameToSend)
{
    double tim;
...
void Ieee80211NewMacWithRA::scheduleBroadcastTimeoutPeriod(Ieee80211DataOrMgmtFrame *frameToSend)
{
    if (!endTimeout->isScheduled())
    {
...
void Ieee80211NewMacWithRA::cancelTimeoutPeriod()
{
    EV << "cancelling timeout period\n";
    cancelEvent(endTimeout);
}

void Ieee80211NewMacWithRA::scheduleCTSTimeoutPeriod()
{
    if (!endTimeout->isScheduled())
    {
...
void Ieee80211NewMacWithRA::scheduleReservePeriod(Ieee80211Frame *frame)
{
...
void Ieee80211NewMacWithRA::invalidateBackoffPeriod()
{
    backoffPeriod() = -1;
}

bool Ieee80211NewMacWithRA::isInvalidBackoffPeriod()
{
    return backoffPeriod() == -1;
}

void Ieee80211NewMacWithRA::generateBackoffPeriod()
{
...
void Ieee80211NewMacWithRA::decreaseBackoffPeriod()
{
    // see spec 9.9.1.5
...
void Ieee80211NewMacWithRA::scheduleBackoffPeriod()
{
    EV << "scheduling backoff period\n";
    scheduleAt(simTime() + backoffPeriod(), endBackoff());
}

void Ieee80211NewMacWithRA::cancelBackoffPeriod()
{
 ...
 */
void Ieee80211NewMacWithRA::sendACKFrameOnEndSIFS()
{
...
void Ieee80211NewMacWithRA::sendACKFrame(Ieee80211DataOrMgmtFrame *frameToACK)
{
...
void Ieee80211NewMacWithRA::sendDataFrameOnEndSIFS(Ieee80211DataOrMgmtFrame *frameToSend)
{
...
void Ieee80211NewMacWithRA::sendDataFrame(Ieee80211DataOrMgmtFrame *frameToSend)
{
...
void Ieee80211NewMacWithRA::sendRTSFrame(Ieee80211DataOrMgmtFrame *frameToSend)
{
    EV << "sending RTS frame\n";
    sendDown(setBasicBitrate(buildRTSFrame(frameToSend)));
}

void Ieee80211NewMacWithRA::sendBroadcastFrame(Ieee80211DataOrMgmtFrame *frameToSend)
{
    EV << "sending Broadcast frame\n";
    sendDown(setBitrateFrame(buildDataFrame(frameToSend)));
}

void Ieee80211NewMacWithRA::sendCTSFrameOnEndSIFS()
{
...
void Ieee80211NewMacWithRA::sendCTSFrame(Ieee80211RTSFrame *rtsFrame)
{
 ...
 */
Ieee80211DataOrMgmtFrame *Ieee80211NewMacWithRA::buildDataFrame(Ieee80211DataOrMgmtFrame *frameToSend)
{
...
Ieee80211ACKFrame *Ieee80211NewMacWithRA::buildACKFrame(Ieee80211DataOrMgmtFrame *frameToACK)
{
...
Ieee80211RTSFrame *Ieee80211NewMacWithRA::buildRTSFrame(Ieee80211DataOrMgmtFrame *frameToSend)
{
...
Ieee80211CTSFrame *Ieee80211NewMacWithRA::buildCTSFrame(Ieee80211RTSFrame *rtsFrame)
{
...
Ieee80211DataOrMgmtFrame *Ieee80211NewMacWithRA::buildBroadcastFrame(Ieee80211DataOrMgmtFrame *frameToSend)
{
    Ieee80211DataOrMgmtFrame *frame = (Ieee80211DataOrMgmtFrame *)frameToSend->dup();
...
Ieee80211Frame *Ieee80211NewMacWithRA::setBasicBitrate(Ieee80211Frame *frame)
{
...
Ieee80211Frame *Ieee80211NewMacWithRA::setBitrateFrame(Ieee80211Frame *frame)
{
 ...
 * Helper functions.
 */
void Ieee80211NewMacWithRA::finishCurrentTransmission()
{
    popTransmissionQueue();
    resetStateVariables();
}

void Ieee80211NewMacWithRA::giveUpCurrentTransmission()
{
...
void Ieee80211NewMacWithRA::retryCurrentTransmission()
{
...
void Ieee80211NewMacWithRA::setMode(Mode mode)
{
    if (mode == PCF)
...
void Ieee80211NewMacWithRA::resetStateVariables()
{
    backoffPeriod() = 0;
    if (rateControlMode == RATE_AARF || rateControlMode == RATE_ARF)
        reportDataOk ();
...
bool Ieee80211NewMacWithRA::isMediumStateChange(cMessage *msg)
{
    return msg == mediumStateChange || (msg == endReserve && radioState == RadioState::IDLE);
}

bool Ieee80211NewMacWithRA::isMediumFree()
{
    return radioState == RadioState::IDLE && !endReserve->isScheduled();
}

bool Ieee80211NewMacWithRA::isBroadcast(Ieee80211Frame *frame)
{
    return ( frame && frame->getReceiverAddress().isBroadcast() ) ||
           ( frame && frame->getReceiverAddress().isMulticast() );
}

bool Ieee80211NewMacWithRA::isForUs(Ieee80211Frame *frame)
{
    return frame && frame->getReceiverAddress() == address;
}

bool Ieee80211NewMacWithRA::isSentByUs(Ieee80211Frame *frame)
{
...
bool Ieee80211NewMacWithRA::isDataOrMgmtFrame(Ieee80211Frame *frame)
{
    return dynamic_cast<Ieee80211DataOrMgmtFrame*>(frame);
}

bool Ieee80211NewMacWithRA::isMsgAIFS(cMessage *msg)
{
    for (int i =0; i<numCategories(); i++)
        if (msg == endAIFS(i))
            return true;
...
Ieee80211Frame *Ieee80211NewMacWithRA::getFrameReceivedBeforeSIFS()
{
    return (Ieee80211Frame *)endSIFS->getContextPointer();
}

void Ieee80211NewMacWithRA::popTransmissionQueue()
{
...
double Ieee80211NewMacWithRA::computeFrameDuration(Ieee80211Frame *msg)
{
...
double Ieee80211NewMacWithRA::computeFrameDuration(int bits, double bitrate)
{
    double duration;
#if 0
    if (opMode=='a') // changed from g to a
        duration=4*ceil((16+bits+6)/(bitrate/1e6*4))*1e-6 + PHY_HEADER_LENGTH;
    else if (opMode=='p') // changed from b to p
    ...
    {
        ModulationType modType;
        if (opMode=='a' || (opMode=='p'))
            modType = WifyModulationType::getMode80211a(bitrate);
        else if (opMode=='g')
            modType = WifyModulationType::getMode80211g(bitrate);
        else if (opMode=='b')
            modType = WifyModulationType::getMode80211b(bitrate);
        else
            opp_error("Opmode not supported");
    ...
    {
        if ((opMode=='a') || (opMode=='g') || (opMode=='b')) // opMode has been changed
            duration=4*ceil((16+bits+6)/(bitrate/1e6*4))*1e-6 + PHY_HEADER_LENGTH;
        else if (opMode=='p') // changed from  b to p
            duration=bits / bitrate + PHY_HEADER_LENGTH / BITRATE_HEADER;
        else
...
void Ieee80211NewMacWithRA::logState()
{
    std::string a[10];
    std::string b[10];
...
const char *Ieee80211NewMacWithRA::modeName(int mode)
{
...
bool Ieee80211NewMacWithRA::transmissionQueueEmpty()
{
    for (int i=0;i<numCategories();i++)
...
void Ieee80211NewMacWithRA::reportDataOk ()
{
    retryCounter() = 0;
    if (rateControlMode==RATE_CR)
       return;
...
void Ieee80211NewMacWithRA::reportDataFailed (void)
{
    retryCounter()++;
    if (rateControlMode==RATE_CR)
       return;
...
int Ieee80211NewMacWithRA::getMinTimerTimeout (void)
{
    return minTimerTimeout;
}

int Ieee80211NewMacWithRA::getMinSuccessThreshold (void)
{
    return minSuccessThreshold;
}

int Ieee80211NewMacWithRA::getTimerTimeout (void)
{
    return timerTimeout;
}

int Ieee80211NewMacWithRA::getSuccessThreshold (void)
{
    return successThreshold;
}

void Ieee80211NewMacWithRA::setTimerTimeout (int timer_timeout)
{
...
void Ieee80211NewMacWithRA::setSuccessThreshold (int success_threshold)
{
...
void Ieee80211NewMacWithRA::reportRecoveryFailure (void)
{
   ...
   bool Ieee80211NewMacWithRA::needRecoveryFallback (void)
{
    if (retryCounter() == 1)
    {
        return true;
...
bool Ieee80211NewMacWithRA::needNormalFallback (void)
{
...
double Ieee80211NewMacWithRA::getBitrate()
{
    return bitrate;
}

void Ieee80211NewMacWithRA::setBitrate(double rate)
{
    bitrate = rate;
}


int Ieee80211NewMacWithRA::getMaxBitrate(void)
{
    if (opMode=='b')
...
int Ieee80211NewMacWithRA::getMinBitrate(void)
{
    return 0;
}
...
bool & Ieee80211NewMacWithRA::backoff(int i)
{
    if (i==-1)
         i = currentAC;
...
simtime_t & Ieee80211NewMacWithRA::TXOP(int i)
{
    if (i==-1)
         i = currentAC;
    if (i>=(int)edcCAF.size())
...
simtime_t & Ieee80211NewMacWithRA::backoffPeriod(int i)
{
    if (i==-1)
         i = currentAC;
    if (i>=(int)edcCAF.size())
...
int & Ieee80211NewMacWithRA::retryCounter(int i)
{
    if (i==-1)
         i = currentAC;
    if (i>=(int)edcCAF.size())
...
int & Ieee80211NewMacWithRA::AIFSN(int i)
{
    if (i==-1)
         i = currentAC;
    if (i>=(int)edcCAF.size())
...
int & Ieee80211NewMacWithRA::cwMax(int i)
{
    if (i==-1)
         i = currentAC;
    if (i>=(int)edcCAF.size())
...
int & Ieee80211NewMacWithRA::cwMin(int i)
{
    if (i==-1)
         i = currentAC;
    if (i>=(int)edcCAF.size())
...
cMessage * Ieee80211NewMacWithRA::endAIFS(int i)
{
    if (i==-1)
         i = currentAC;
    if (i>=(int)edcCAF.size())
...
cMessage * Ieee80211NewMacWithRA::endBackoff(int i)
{
    if (i==-1)
         i = currentAC;
    if (i>=(int)edcCAF.size())
...
const bool Ieee80211NewMacWithRA::isBakoffMsg(cMessage *msg)
{
    for(unsigned int i=0;i<edcCAF.size();i++)
    {
...
// Statistics
long & Ieee80211NewMacWithRA::numRetry(int i)
{
    if (i==-1)
         i = currentAC;
    if (i>=(int)edcCAF.size())
...
long & Ieee80211NewMacWithRA::numSentWithoutRetry(int i)
{
    if (i==-1)
         i = currentAC;
...
long & Ieee80211NewMacWithRA::numGivenUp(int i)
{
    if (i==-1)
         i = currentAC;
    if (i>=(int)edcCAF.size())
...
long & Ieee80211NewMacWithRA::numSent(int i)
{
    if (i==-1)
         i = currentAC;
    if (i>=(int)edcCAF.size())
...
long & Ieee80211NewMacWithRA::numDropped(int i)
{
    if (i==-1)
         i = currentAC;
    if (i>=(int)edcCAF.size())
...
long & Ieee80211NewMacWithRA::bites(int i)
{
    if (i==-1)
         i = currentAC;
    if (i>=(int)edcCAF.size())
...
simtime_t & Ieee80211NewMacWithRA::minjitter(int i)
{
    if (i==-1)
         i = currentAC;
    if (i>=(int)edcCAF.size())
...
simtime_t & Ieee80211NewMacWithRA::maxjitter(int i)
{
    if (i==-1)
         i = currentAC;
    if (i>=(int)edcCAF.size())
...
cOutVector * Ieee80211NewMacWithRA::jitter(int i)
{
    if (i==-1)
         i = currentAC;
    if (i>=(int)edcCAF.size())
...
cOutVector * Ieee80211NewMacWithRA::macDelay(int i)
{
    if (i==-1)
         i = currentAC;
    if (i>=(int)edcCAF.size())
...
cOutVector * Ieee80211NewMacWithRA::throughput(int i)
{
    if (i==-1)
         i = currentAC;
    if (i>=(int)edcCAF.size())
...
Ieee80211NewMacWithRA::Ieee80211DataOrMgmtFrameList * Ieee80211NewMacWithRA::transmissionQueue(int i)
{
    if (i==-1)
        i = currentAC;
    if (i>=(int)edcCAF.size())
...
ModulationType
Ieee80211NewMacWithRA::getControlAnswerMode (ModulationType reqMode)
{
  /**
...
void Ieee80211NewMacWithRA::sendUp(cMessage *msg)
{
    EV << "sending up " << msg << "\n";
...
void Ieee80211NewMacWithRA::removeOldTuplesFromDuplicateMap()
{
