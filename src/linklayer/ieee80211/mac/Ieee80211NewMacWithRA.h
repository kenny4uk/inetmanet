...
#ifndef IEEE_80211New_MAC_WITH_RA_H
#define IEEE_80211New_MAC_WITH_RA_H
 ...
 * @ingroup macLayer
 */
class INET_API Ieee80211NewMacWithRA : public WirelessMacBase, public INotifiable
{
...
//    cMessage *endAIFS[4];
  ...
  public:
     ...
     */
    //@{
    Ieee80211NewMacWithRA();
    virtual ~Ieee80211NewMacWithRA();
    //@}
